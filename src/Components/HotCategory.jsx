...
const HotCategory = () => {
  return (
    <div className="w-full flex md:flex-row flex-col gap-4 md:gap-0 items-center justify-center py-4 xl:px-[13rem] px-3">
      <div className="md:w-[5%] flex justify-center">
        <h2 className="sm:text-4xl uppercase font-semibold md:rotate-90 text-nowrap text-center">
